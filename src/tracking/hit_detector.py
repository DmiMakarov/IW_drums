...
class HitDetector:
    def __init__(self, cfg: HitConfig = HitConfig()):
        self.cfg = cfg
        self.prev_vy = 0.0
        self.prev2_vy = 0.0
        self.refractory = 0
    ...
    def update(self, vy: float) -> bool:
        """Return True if a hit is detected this frame using velocity sign change
        with minimum downward speed and acceleration constraint.
